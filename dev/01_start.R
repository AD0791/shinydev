...
golem::fill_desc(
  ...
  pkg_description = "A basic use of the framework and the shiny.", # The Description of the package containing the App
...
usethis::use_mit_license("Alexandro Disla") # You can set another license here
usethis::use_readme_rmd(open = FALSE)
devtools::build_readme()
# Note that `contact` is required since usethis version 2.1.5
# If your {usethis} version is older, you can remove that param
usethis::use_code_of_conduct(contact = "Alexandro Disla")
